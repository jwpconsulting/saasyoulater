...
var _user$project$Model$lowestFreeId = function (scenarios) {
	var findFree = function (x) {
		findFree:
		while (true) {
			if (A2(_elm_lang$core$Dict$member, x, scenarios)) {
				var _v0 = x + 1;
				x = _v0;
				continue findFree;
			} else {
...
var _user$project$Model$firstScenarioID = function (scenarios) {
	return _elm_lang$core$List$minimum(
		_elm_lang$core$Dict$keys(scenarios));
};
var _user$project$Model$currencyKey = 'currency';
var _user$project$Model$setChurn = F2(
	function (scenario, churnRate) {
		var customerGrowth = scenario.customerGrowth;
		var customerGrowth_ = _elm_lang$core$Native_Utils.update(
			customerGrowth,
			{churnRate: churnRate});
...
var _user$project$Model$newScenario = {months: 24, revenue: 30, customerGrowth: _user$project$Model$emptyRelative, revenueGrossMargin: 0.5, cac: 45, fixedCost: 100, name: _elm_lang$core$Maybe$Nothing, comment: _elm_lang$core$Maybe$Nothing};
var _user$project$Model$newScenarios = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
...
var _user$project$Model$CustomerGrowth = F3(
	function (a, b, c) {
		return {startValue: a, growthRate: b, churnRate: c};
	});
var _user$project$Model$Scenario = F8(
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'start',
				_1: _elm_lang$core$Json_Encode$int(customerGrowth.startValue)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'growth',
					_1: _elm_lang$core$Json_Encode$float(customerGrowth.growthRate)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'churn',
						_1: _elm_lang$core$Json_Encode$float(customerGrowth.churnRate)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$Encode$nullableString = function (_p0) {
	return A2(
							...
							_1: {
								...
								_1: {
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'comment',
										_1: _user$project$Encode$nullableString(scenario.comment)
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'name',
											_1: _user$project$Encode$nullableString(scenario.name)
										},
										_1: {ctor: '[]'}
									}
								}
...
var _user$project$Encode$encodeScenarios = function (scenarios) {
	return _elm_lang$core$Json_Encode$object(
		A2(
			_elm_lang$core$List$map,
			function (_p1) {
				...
				return {
					...
					_1: _user$project$Encode$encodeScenario(_p2._1)
				};
			},
...
var _user$project$Msg$SetRevenue = {ctor: 'SetRevenue'};
...
var _user$project$Msg$DeleteScenario = function (a) {
	return {ctor: 'DeleteScenario', _0: a};
};
...
var _user$project$Msg$NewScenario = {ctor: 'NewScenario'};
var _user$project$Msg$ChooseScenario = function (a) {
	return {ctor: 'ChooseScenario', _0: a};
};
var _user$project$Msg$SetScenario = F3(
	function (a, b, c) {
		return {ctor: 'SetScenario', _0: a, _1: b, _2: c};
	});

var _user$project$Cmds$storeCurrency = function (currency) {
	return _user$project$LocalStorage$set(
		{
			ctor: '_Tuple2',
	...
	return _user$project$LocalStorage$set(
		{
			...
			_1: A2(
				...
				0,
				_user$project$Encode$encodeScenarios(model.scenarios))
		});
};
var _user$project$Cmds$retrieveScenarios = _user$project$LocalStorage$get('scenarios');
var _user$project$Cmds$retrieveCurrency = _user$project$LocalStorage$get('currency');
var _user$project$Cmds$startCmds = _elm_lang$core$Platform_Cmd$batch(
	{
		ctor: '::',
		_0: _user$project$Cmds$retrieveCurrency,
		_1: {
			ctor: '::',
			_0: _user$project$Cmds$retrieveScenarios,
			_1: {ctor: '[]'}
		}
	});
					...
					A2(
						...
						A2(
							...
							function (_p8) {
								...
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$String$toInt(_p9._0),
									_1: _p9._1
								};
							},
...
var _user$project$Decode$customerGrowth = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Model$CustomerGrowth,
	A2(_elm_lang$core$Json_Decode$field, 'start', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'growth', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode$field, 'churn', _elm_lang$core$Json_Decode$float));
var _user$project$Decode$scenario = A9(
	_elm_lang$core$Json_Decode$map8,
	_user$project$Model$Scenario,
	A2(_elm_lang$core$Json_Decode$field, 'months', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'revenue', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'customerGrowth', _user$project$Decode$customerGrowth),
	A2(_elm_lang$core$Json_Decode$field, 'revenueGrossMargin', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode$field, 'cac', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'fixedCost', _elm_lang$core$Json_Decode$int),
	A2(
		...
		_0: A2(
			_elm_lang$html$Html$span,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					(_elm_lang$core$Native_Utils.cmp(value, 1) < 0) ? 'text-warning' : 'text-success'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Humanize$humanizeValue = F2(
...
var _user$project$Humanize$humanizeDuration = function (month) {
	var suffix = function () {
		var _p0 = month;
		if (_p0 === 1) {
			return ' month';
...
var _user$project$Humanize$humanize = function (month) {
	var _p1 = month;
	if (_p1.ctor === 'Just') {
		return {
			ctor: '::',
			_0: _elm_lang$html$Html$text('At month '),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$strong,
		...
		return {
			ctor: '::',
			_0: _elm_lang$html$Html$text('Never'),
			_1: {ctor: '[]'}
		};
	}
};
				...
				if (_p5.ctor === 'Nothing') {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model_,
							{
								currentScenario: _user$project$Model$firstScenarioID(model_.scenarios)
							}),
						{
							ctor: '::',
				...
				switch (_p9.ctor) {
					case 'SetMonths':
						return _elm_lang$core$Native_Utils.update(
							scenario,
							{
								months: A2(_user$project$Decode$decodeIntWithMaximum, value, _user$project$Model$maxMonths)
							});
					case 'SetCustomerStart':
						return A2(
							_user$project$Model$setStartValue,
							scenario,
							_user$project$Decode$decodeInt(value));
					case 'SetChurnRate':
						return A2(
							_user$project$Model$setChurn,
							scenario,
							_user$project$Decode$decodePercentage(value));
					case 'SetCustomerGrowth':
						return A2(
							_user$project$Model$updateGrowth,
							scenario,
							_user$project$Decode$decodePercentage(value));
					case 'SetRevenue':
						return _elm_lang$core$Native_Utils.update(
							scenario,
							{
								revenue: _user$project$Decode$decodeInt(value)
							});
					case 'SetCAC':
						return _elm_lang$core$Native_Utils.update(
							scenario,
							{
								cac: _user$project$Decode$decodeInt(value)
							});
					case 'SetMargin':
						return _elm_lang$core$Native_Utils.update(
							scenario,
							{
								revenueGrossMargin: _user$project$Decode$decodePercentage(value)
							});
					case 'SetFixedCost':
						return _elm_lang$core$Native_Utils.update(
							scenario,
							{
								fixedCost: _user$project$Decode$decodeInt(value)
							});
					case 'SetName':
						return _elm_lang$core$Native_Utils.update(
							scenario,
							{
								name: _user$project$Update$maybeString(value)
							});
					default:
						return _elm_lang$core$Native_Utils.update(
							scenario,
							{
								comment: _user$project$Update$maybeString(value)
							});
				}
			});
		...
		switch (_p11.ctor) {
			...
			case 'ChooseScenario':
				...
				return A2(_elm_lang$core$Dict$member, _p12, model.scenarios) ? A2(
					...
					{ctor: '[]'});
			case 'NewScenario':
				var highest = _user$project$Model$lowestFreeId(model.scenarios);
				var scenarios_ = A3(_elm_lang$core$Dict$insert, highest, _user$project$Model$newScenario, model.scenarios);
				var model_ = _elm_lang$core$Native_Utils.update(
					model,
					{
						scenarios: scenarios_,
						currentScenario: _elm_lang$core$Maybe$Just(highest)
					});
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model_,
			...
			case 'SetCurrency':
				...
				return A2(
					...
					{
						ctor: '::',
						_0: _user$project$Cmds$storeCurrency(currency),
						_1: {ctor: '[]'}
					});
			...
			default:
				...
				var model_ = _elm_lang$core$Native_Utils.update(
					model,
					{scenarios: scenarios, currentScenario: currentScenario});
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model_,
					{
...
var _user$project$Math$averageLife = function (model) {
	return _elm_lang$core$Basics$round(1 / model.customerGrowth.churnRate);
};
...
var _user$project$Math$ltvcac = function (model) {
	return _elm_lang$core$Basics$toFloat(
		_user$project$Math$cltv(model)) / _elm_lang$core$Basics$toFloat(model.cac);
};
var _user$project$Math$linspace = F3(
	function (start, stop, n) {
		...
		if (_p0 === 1) {
			...
			var h = _elm_lang$core$Basics$toFloat(stop - start) / _elm_lang$core$Basics$toFloat(n - 1);
			return A2(
				_elm_lang$core$List$map,
				...
				A2(
					_elm_lang$core$List$map,
					function (n) {
						return _elm_lang$core$Basics$toFloat(start) + (n * h);
					},
					A2(
						_elm_lang$core$List$map,
...
var _user$project$Math$months = function (months) {
	return A3(
		_user$project$Math$linspace,
		1,
		months,
		A2(_elm_lang$core$Basics$min, months, 12));
};
var _user$project$Math$effectiveGrowth = function (customerGrowth) {
	return 1 + (customerGrowth.growthRate - customerGrowth.churnRate);
};
var _user$project$Math$customers = F2(
	function (customerGrowth, month) {
		return _elm_lang$core$Basics$round(
			_elm_lang$core$Basics$toFloat(customerGrowth.startValue) * Math.pow(
				_user$project$Math$effectiveGrowth(customerGrowth),
				_elm_lang$core$Basics$toFloat(month - 1)));
	});
var _user$project$Math$revenue = F2(
	function (scenario, month) {
		return A2(_user$project$Math$customers, scenario.customerGrowth, month) * scenario.revenue;
	});
...
var _user$project$Math$customerGrowth = F2(
	function (customerGrowth, month) {
		var c = _user$project$Math$customers(customerGrowth);
		return A2(
...
var _user$project$Math$customerAcquisitionCost = F2(
	function (scenario, month) {
		...
		return 0 - (_elm_lang$core$Basics$round(customersAdded) * scenario.cac);
	});
...
var _user$project$Math$earnings = F2(
	function (model, month) {
		return A2(_user$project$Math$grossMargin, model, month) - A2(_user$project$Math$expenses, model, month);
	});
var _user$project$Math$cumulativeEarnings = F2(
	function (model, month) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$Math$earnings(model),
				A2(_elm_lang$core$List$range, 1, month)));
	});
var _user$project$Math$breakEvenWithMonth = F2(
	function (model, month) {
		breakEvenWithMonth:
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(
				A2(_user$project$Math$cumulativeEarnings, model, month),
				0) > -1) {
				return _elm_lang$core$Maybe$Just(month);
			} else {
...
var _user$project$Math$earningsBreakEvenWithMonth = F2(
	function (model, month) {
		...
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(
				A2(_user$project$Math$earnings, model, month),
				0) > -1) {
				return _elm_lang$core$Maybe$Just(month);
			} else {
				if (_elm_lang$core$Native_Utils.cmp(month, model.months) > -1) {
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Length of business forecast'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Churn Rate'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Percentage of customers leaving monthly'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
...
var _user$project$View$results = F2(
	function (currency, scenario) {
		var ltvcac = _user$project$Humanize$humanizeRatio(
			_user$project$Math$ltvcac(scenario));
		var averageLife = _user$project$Humanize$humanizeDuration(
			_user$project$Math$averageLife(scenario));
		var earningsBreakEven = _user$project$Humanize$humanize(
			_user$project$Math$earningsBreakEven(scenario));
		var breakEven = _user$project$Humanize$humanize(
			_user$project$Math$breakEven(scenario));
		var hv = _user$project$Humanize$humanizeValue(currency);
		var cltv = hv(
			_user$project$Math$cltv(scenario));
		var minimumCumulativeEarnings = hv(
			_user$project$Math$minimumCumulativeEarnings(scenario));
		return {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$h2,
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Average Customer Life'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Currency'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _user$project$View$numbers = F2(
	function (currency, scenario) {
		...
		var breakEven = _user$project$Math$breakEven(scenario);
		var months = _user$project$Math$monthRange(scenario.months);
		var hv = _user$project$Humanize$humanizeValue(currency);
		var row = function (month) {
			var tdright = _elm_lang$html$Html$td(
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('text-right'),
					_1: {ctor: '[]'}
				});
			var trClass = _elm_lang$html$Html_Attributes$class(
				A2(
					_elm_lang$core$Maybe$withDefault,
					'danger',
					A2(
						...
						function (breakEvenMonth) {
							return (_elm_lang$core$Native_Utils.cmp(month, breakEvenMonth) > -1) ? 'success' : 'warning';
						},
						breakEven)));
			return A2(
				...
				A2(
					...
					A2(
								...
								_0: {
									...
									_0: _elm_lang$html$Html$text(
										_elm_lang$core$Basics$toString(
											A2(_user$project$Math$customers, scenario.customerGrowth, month))),
									_1: {ctor: '[]'}
								},
								_1: {ctor: '[]'}
							}
						...
						A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Math$revenue, scenario, month),
								_1: {
									ctor: '::',
									_0: A2(_user$project$Math$grossMargin, scenario, month),
									_1: {
										ctor: '::',
										_0: A2(_user$project$Math$expenses, scenario, month),
										_1: {
											ctor: '::',
											_0: A2(_user$project$Math$earnings, scenario, month),
											_1: {
												ctor: '::',
												_0: A2(_user$project$Math$cumulativeEarnings, scenario, month),
												_1: {ctor: '[]'}
											}
										}
									}
		...
		var rows = A2(
			_elm_lang$core$List$map,
			row,
			_user$project$Math$months(scenario.months));
		return {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$h2,
...
var _user$project$View$newTab = A2(
	_elm_lang$html$Html$li,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$a,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Msg$NewScenario),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('+ Add a Scenario'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
					...
					_0: A2(
						...
						A2(
							...
							A2(
								...
								_elm_lang$core$Dict$toList(model.scenarios)),
							{
								ctor: '::',
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$Model$init, _1: _user$project$Cmds$startCmds},

...
var _user$project$Msg$SetChurnRate = function (a) {
	return {ctor: 'SetChurnRate', _0: a};
};
var _user$project$Msg$SetMonths = function (a) {
	return {ctor: 'SetMonths', _0: a};
};
...
var _user$project$Humanize$humanizeValue = function (value) {
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
...
var _user$project$Humanize$humanize = function (month) {
	...
	if (_p1.ctor === 'Just') {
		return _elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('At month '),
				A2(
				_elm_lang$html$Html$strong,
				_elm_lang$core$Native_List.fromArray(
					[]),
		...
		return _elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Never')
			]);
	}
};
			...
			case 'SetMonths':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							months: A2(_user$project$Update$decodeIntWithMaximum, _p2._0, _user$project$Model$maxMonths)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'SetChurnRate':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							churnRate: _user$project$Update$decodePercentage(_p2._0)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'SetCustomerGrowth':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							customerGrowth: _user$project$Update$decodeInt(_p2._0)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			...
			case 'SetCAC':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							cac: _user$project$Update$decodeInt(_p2._0)
						}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			default:
	...
	function (model, month) {
		return A3(
			...
			A2(
				...
				_elm_lang$core$Native_List.range(1, model.months)));
	});
	...
	function (model, month) {
		return A3(
			...
			A2(
				...
				_elm_lang$core$Native_List.range(1, month)));
	});
...
var _user$project$View$results = function (model) {
	var minimumCumulativeEarnings = _user$project$Humanize$humanizeValue(
		_user$project$Math$minimumCumulativeEarnings(model));
	var ltvcac = _user$project$Humanize$humanizeRatio(
		_user$project$Math$ltvcac(model));
	var cltv = _user$project$Humanize$humanizeValue(
		_elm_lang$core$Basics$toFloat(
			_user$project$Math$cltv(model)));
	var averageLife = _user$project$Humanize$humanizeDuration(
		_user$project$Math$averageLife(model));
	var earningsBreakEven = _user$project$Humanize$humanize(
		_user$project$Math$earningsBreakEven(model));
	var breakEven = _user$project$Humanize$humanize(
		_user$project$Math$breakEven(model));
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Average Customer Life')
						])),
					A2(
					_elm_lang$html$Html$dd,
					_elm_lang$core$Native_List.fromArray(
...
var _user$project$View$numbers = function (model) {
	var breakEven = _user$project$Math$breakEven(model);
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Basics$round(
									A2(_user$project$Math$customerCohorts, model, month))))
						])),
					A2(
					_elm_lang$html$Html$td,
					_elm_lang$core$Native_List.fromArray(
						[]),
					_user$project$Humanize$humanizeValue(
						A2(_user$project$Math$revenueCohorts, model, month))),
					A2(
					_elm_lang$html$Html$td,
					_elm_lang$core$Native_List.fromArray(
						[]),
					_user$project$Humanize$humanizeValue(
						A2(_user$project$Math$grossMargin, model, month))),
					A2(
					_elm_lang$html$Html$td,
					_elm_lang$core$Native_List.fromArray(
						[]),
	...
	var rows = A2(
		_elm_lang$core$List$map,
		row,
		_user$project$Math$months(model.months));
	var months = _elm_lang$core$Native_List.range(1, model.months);
	return _elm_lang$core$Native_List.fromArray(
		[
			A2(
			_elm_lang$html$Html$h2,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('table table-hover table-condensed')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Customers')
										])),
									A2(
									_elm_lang$html$Html$th,
									_elm_lang$core$Native_List.fromArray(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Revenue')
										])),
									A2(
									_elm_lang$html$Html$th,
									_elm_lang$core$Native_List.fromArray(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Gross Margin')
										])),
									A2(
									_elm_lang$html$Html$th,
									_elm_lang$core$Native_List.fromArray(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Expenses')
										])),
									A2(
									_elm_lang$html$Html$th,
									_elm_lang$core$Native_List.fromArray(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Cumulative EBIT')
										]))
								]))
						])),
					A2(
...
var _user$project$View$controls = function (model) {
	var numberInput = F5(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onInput(message),
	...
	var controlLabel = function (labelText) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('control-label col-xs-6')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(' - SaaS Business Model Calculator')
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('col-xs-6 col-md-3 col-md-push-6')
							]),
						_user$project$View$results(model)),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('col-xs-12 col-md-6 col-md-pull-3')
							]),
						_user$project$View$numbers(model))
					]))
			]));
};
